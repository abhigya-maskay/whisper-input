...
versionOption = O.infoOption (showVersion Paths_whisper_input.version)
  (O.long "version" <> O.help "Show version")

parserInfo :: O.ParserInfo Command
parserInfo = O.info (commandParser O.<**> O.helper O.<**> versionOption) $
  O.fullDesc
